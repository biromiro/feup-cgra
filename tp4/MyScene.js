...
export class MyScene extends CGFscene {
  ...
  init(application) {
    ...
    this.unitCubeQuad = new MyUnitCubeQuad(
      this,
      this.mineTopTexture,
  ...
  display() {
    ...
    if (this.showQuad) this.quadMaterial.apply()
    ...
    if (this.showUnitCubeQuad) this.unitCubeQuad.display()
